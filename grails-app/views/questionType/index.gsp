...
<html>
    ...
    <body>
        <a href="#list-questionType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-questionType" class="content scaffold-list" role="main">
            ...
            <div class="paginationGrails">
                <g:paginate total="${questionTypeCount ?: 0}" />
            </div>
        </div>
    </body>
</html>