...
<html>
    ...
    <body>
        <a href="#list-questionDocument" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-questionDocument" class="content scaffold-list" role="main">
            ...
            <div class="paginationGrails">
                <g:paginate total="${questionDocumentCount ?: 0}" />
            </div>
        </div>
    </body>
</html>